...
public class MailTesting {
	...
	public String sendMail(BirthRegistration b) {
		...
		try {
			...
			File file= new File("C:/Users/HP/Downloads/MunicipalCorporationFinal/MunicipalCorporationFinal/Images/birthCertificate.pdf");
...
public String sendRejectedMail(BirthRegistration b) {
	...
	public String sendMail(DeathRegistration d) {
		...
		try {
			...
			File file= new File("C:/Users/HP/Downloads/MunicipalCorporationFinal/MunicipalCorporationFinal/Images/DeathCertificate.pdf");
			FileOutputStream out=new FileOutputStream(file);
...
public String sendRejectedMail(DeathRegistration d) {
	...
	public String sendMail(MarriageRegistration m) {
		...
		try {
			...
			File file= new File("C:/Users/HP/Downloads/MunicipalCorporationFinal/MunicipalCorporationFinal/Images/marriageCertificate.pdf");
			FileOutputStream out=new FileOutputStream(file);
