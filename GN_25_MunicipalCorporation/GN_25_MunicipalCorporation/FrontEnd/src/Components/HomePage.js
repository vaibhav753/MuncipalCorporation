...
const HomePage = () => {
	...
	const makePayment = (e) => {
        ...
        e.preventDefault();
        console.log(typeof(sessionStorage.getItem("email")));
        ...
        // PropertyService.getPropertyRecordsByEmail(sessionStorage.getItem("email"))
        
            .then((res) => {
                console.log('res ', res.data);
                ReactSession.set("curConNo", res.data[0].consumerNo);
                console.log(ReactSession.get("curConNo"));
            })
            .catch((err) => {
                console.error(err);
            });
