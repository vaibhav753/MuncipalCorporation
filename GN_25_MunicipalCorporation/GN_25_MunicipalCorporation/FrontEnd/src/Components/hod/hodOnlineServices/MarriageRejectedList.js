...
function MarriageRejectedList() {
    ...
    useEffect(() => {
        ...
        axios.get('http://localhost:8080/marriageRegistration/marriageRejectedList', {
            headers: {
    ...
    const Revert = (rowIndex) => {
        ...
        axios.put('http://localhost:8080/marriageRegistration/marriageRejectedlist/'+regId+"/InProcess",null, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + sessionStorage.getItem("tokenId")
            },
...
export default MarriageRejectedList;