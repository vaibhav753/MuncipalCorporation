...
function UVList() {
    ...
    useEffect(() => {
        ...
        axios.get('http://localhost:8080/birthRegistration/uvlist', {
            headers: {
    ...
    const approved = (rowIndex) => {
        ...
        axios.put('http://localhost:8080/birthRegistration/uvlist/'+regId+"/Completed",null, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + sessionStorage.getItem("tokenId")
            },
    ...
    const rejectBirthReg = (rowIndex) => {
       ...
       // BirthRegistrationService.updateStatus(id["id"],"Rejected")
       axios.put('http://localhost:8080/birthRegistration/uvlist/'+id["id"]+"/Rejected", null,{
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + sessionStorage.getItem("tokenId")
            },
