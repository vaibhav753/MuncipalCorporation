    ...
    return (
        <div className='app'>
          ...
          <InfoBox title="Deaths" cases={countryInfo.todayDeaths} total={countryInfo.deaths}></InfoBox> */}
                    ...
                    <InfoBox onClick={(e) => setCasesType("cases")} title="Coronavirus Cases" cases={todayCase} total={cases}></InfoBox>
                    <InfoBox onClick={(e) => setCasesType("recovered")} title="Recovered" cases={todayRecover} total={recovers}></InfoBox>
                    <InfoBox onClick={(e) => setCasesType("deaths")} title="Deaths" cases={todayDeath} total={deaths}></InfoBox>
                </div>
